			...
			<Container>
				...
				<Row xs={1} sm={1} md={1} lg={1} className='serv-row'>
					...
					<Col className='center serv-img'>
						<Image src={Departments} fluid='true'/>
					</Col>
					<Col>Located in central Texas, Talarai offers a full line of customized solutions for government agencies in the information technology and management field, including AI, IT Consulting, Web Design and Development, Project Management Services, Software, and App Development Solutions Management, and more. We are continuously evolving to meet our Federal, State, and Local client’s needs and ensure our solutions remain current with the latest trends in the technology industry.
					<br/><br/>
